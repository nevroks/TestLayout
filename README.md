...
Данный проект в начале дали мне как тестовое задание а потом я уже его дорабатывал работая в компании,
но после переосмысленяи компании было решено забить на этот сайт<br/>
